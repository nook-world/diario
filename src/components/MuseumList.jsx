    ...
    <div className={styles.museumList}>
      ...
      {type !== "fossils" && (
        <article className={styles.museumListArticle}>
          ...
          <p>
            {language.youCanCheckOnYourNookPhoneInTheOption}{" "}
            <strong>Critterpedia</strong>
          </p>
          <img
          ...
          <h2>
            {language.howCanISeeWhichCreaturesIAlreadyDonatedToTheMuseum}?
          </h2>
          <p>
            {language.onTheCritterpediaAppYouWillSeeAnIconFrom}{" "}
            <strong>
              <Museum className={styles.museumListArticleIcon} /> Blathers
            </strong>{" "}
            {language.onTheCreaturesYouAlreadyDonated}
          </p>
        </article>
      )}
      {type === "fossils" && (
        <article className={styles.museumListArticle}>
          ...
          <p>
            {language.goToNookTerminalAndSelect} <strong>Nook Shopping</strong>.
          </p>
          <img
            className={styles.museumListArticleImage}
          ...
          />
          <p>
            {language.accessTheOption}{" "}
            <strong>Wallpaper, flooring and more</strong>.
          </p>
          <img
            className={styles.museumListArticleImage}
          ...
          />
          <p>
            {language.filterTheResultsFromTheShoppingBy}{" "}
            <strong>{language.fossils} </strong>.
          </p>
          <img
            className={styles.museumListArticleImage}
